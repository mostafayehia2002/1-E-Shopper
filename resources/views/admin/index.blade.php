...
@section('content')
   ...
   <a href="{{route('admin.showAdmins')}}" class="fa-bounce box" >
    ...
    <a href="{{route('admin.showUsers')}}" class="fa-bounce box">
...
<a href="{{route('admin.showProducts')}}" class="fa-bounce box">
...
<a href="{{route('admin.showOrders')}}" class="fa-bounce box">
    ...
    <div class="box-name">Show Orders </div>
        ...
        <a href="{{route('admin.showCategories')}}" class="fa-bounce box">
